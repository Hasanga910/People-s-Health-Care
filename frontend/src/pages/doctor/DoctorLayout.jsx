...
const PATH_TO_PAGE = {
  ...
  "/doctor/heart-predict":     "Heart Disease Predictor",
...
// ── Option 1 time-window logic ────────────────────────────────────────────────
// Critical results  → last 48 hours (patient safety — can't silently disappear)
...
function isNotifRelevant(isoTime, type, id, unreadIds) {
  ...
  const twoDaysAgo     = new Date(todayStart - 2 * 86_400_000);

  if (type === "critical") return t >= twoDaysAgo;          // 48 h for safety
