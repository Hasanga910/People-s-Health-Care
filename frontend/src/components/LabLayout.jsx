...
const NAV_ITEMS = [
  ...
  { label: "Test Requests", href: "/lab/requests", badge: "4", icon: (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className="w-5 h-5"><path d="M9 3H5a2 2 0 00-2 2v4m6-6h10a2 2 0 012 2v4M9 3v11m0 0H5m4 0h10m-10 0v4a2 2 0 002 2h4" /></svg>) },
        ...
        <div className="flex items-center gap-3 px-5 py-5 border-b border-white/10">
          <div className="w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0"
            ...
            <svg viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" className="w-5 h-5">
              <path d="M9 3l-1 9h8L15 3H9z"/><path d="M8 12c0 4 4 7 4 7s4-3 4-7"/><line x1="12" y1="3" x2="12" y2="1"/>
            </svg>
          </div>
          {sidebarOpen && (
            ...
            <div className="relative">
              ...
              {notifOpen && (
                <div className="absolute right-0 top-12 w-80 bg-white rounded-2xl shadow-2xl border border-gray-100 z-50 overflow-hidden">
                  ...
                  {[
                    { icon: "🚨", msg: "Urgent: ECG requested for Ruwan Fernando", time: "5 min ago" },
                    { icon: "🧪", msg: "New lab request — 3 tests from Dr. Jayaweera", time: "20 min ago" },
                    { icon: "⚙️", msg: "Chemistry Analyzer maintenance overdue", time: "1 hr ago" },
                  ].map((n, i) => (
                    <div key={i} className="flex items-start gap-3 p-4 hover:bg-gray-50 cursor-pointer border-b border-gray-50 transition">
                      <div className="w-9 h-9 rounded-xl flex items-center justify-center text-base flex-shrink-0 bg-teal-50">
                        {n.icon}
                      </div>
                      <div>
