...
export default function PatientLayout({ children, activePage = "My Dashboard" }) {
  ...
  return (
    <div style={{ fontFamily: "'DM Sans', sans-serif" }} className="flex h-screen bg-gray-50 overflow-hidden">
      {/* ── SIDEBAR ── */}
      <aside
        className={`relative flex flex-col text-white transition-all duration-300 flex-shrink-0 ${
      ...
      >
        ...
        {sidebarOpen && (
          <div className="mx-4 mt-4 p-3 rounded-xl bg-white/5 border border-white/10">
            <div className="flex items-center gap-3">
              ...
              <div className="overflow-hidden">
                <div className="text-sm font-semibold truncate">Kamal Perera</div>
                <div className="text-white/40 text-xs">PHC-2026-0012 · B+</div>
              </div>
        ...
        <div className="p-4 border-t border-white/10 space-y-2">
          <a
            ...
            className={`flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm text-white/60 hover:bg-white/10 hover:text-white transition ${
              !sidebarOpen ? "justify-center" : ""
            }`}
          >
          ...
          <div className="ml-auto flex items-center gap-4">
                ...
                <div className="absolute right-0 top-12 w-80 bg-white rounded-2xl shadow-2xl border border-gray-100 z-50 overflow-hidden">
                  ...
                  {[
                    ...
                    <div key={i} className="flex items-start gap-3 p-4 hover:bg-gray-50 cursor-pointer border-b border-gray-50 transition">
                      <div className="w-9 h-9 rounded-xl flex items-center justify-center text-base flex-shrink-0" style={{ background: `${n.color}15` }}>
                        {n.icon}
                      </div>
                      <div>
            ...
            <div className="flex items-center gap-2 cursor-pointer">
              ...
              <div className="hidden md:block">
                <div className="text-sm font-semibold text-gray-800">Kamal Perera</div>
